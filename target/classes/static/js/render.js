function renderHeaderAndPost() {
                ...
                <div class="dropdown-profile" id="dropdown-profile">
                    <ul>
                        ...
                        <li> 
                            ...
                            <a href="/chat">Cài đặt quyền riêng tư</a>
                        </li>
                        <li>
  ...
  const newPost = `<div class="overlay1" id="overlay">
    ...
    <div id="fileVideo" style="display:none;">
                          <span id="closevideo" onclick="closeVideo()">X</span>
                          <label for="video">
                              <img src="/img/icons/video-live.svg" alt="gallery" />
                              <br>
                          ...
                          <input type="file" id="video" name="video" accept="video/*" />
                            ...
                            <ul class="list">
                                ...
                                <li><img th:src="@{/img/icons/video-live.svg}" alt="gallery" onclick="toggleVideo()" /></li>
